...
from schemas.story import StoryBase, StoryNodeBase, CreateStoryRequest, CompleteStoryResponse, CompleteStoryNodeResponse
...
def generate_story_task(job_id: str, session_id: str, theme: str, db: Session = Depends(get_db)):
    db = SessionLocal()
    ...
    try:
        ...
        story = StoryGenerator.generate_story(session_id=session_id,db=db,theme=theme)
...
def get_story(story_id: int, db: Session = Depends(get_db)):
    ...
    complete_story = build_complete_story_tree(db, story)  # returns CompleteStoryResponse
